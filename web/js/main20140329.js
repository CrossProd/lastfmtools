...
function UpdatePreview()
{
    ...
    var headerColor = $('#headerColorSelectBox').val();
    
    var playCountVisible = $('#playCountVisibleSelectBox').val();
    ...
    switch (selectedSubMenu)
    {
        case "albumCollage":
            url = style == 0 ? 
                        "collage/topalbums_var01/" + username + "," + period  + "," + border + "," + headerColor + "," + playCountVisible + ".jpg" :
                        "collage/topalbums/" + username + "," + period  + "," + cols + "," + rows + "," + border + "," + headerColor + "," + playCountVisible + ".jpg";                
            break;
        case "artistCollage":
            url = style == 0 ? 
                        "collage/topartists_var01/" + username + "," + period  + "," + border + "," + headerColor + "," + playCountVisible + ".jpg" :
                        "collage/topartists/" + username + "," + period  + "," + cols + "," + rows + "," + border + "," + headerColor + "," + playCountVisible + ".jpg";
            break;
        case "artistTypewriter":     
            url = "typewriter/topartists/" + username + "," + period + "," + font + "," + fontCase + "," + background + "," + mask + "," + distortion + "," + headerColor + ".png";               
            break;
        case "artistSpiral":     
            url = "spiral/topartists/" + username + "," + period  + "," + spiralColor + "," + headerColor + ".png";
            break;
    }
    ...
    var bbcode =
        "[url=http://lastfmtools.com/][img]" + imageUrl + "[/img][/url]";
...
function UpdateSettingsForm(animate)
{
    ...
    if (selectedSubMenu == "artistCollage" || selectedSubMenu == "albumCollage")
    {
        ...
        if (selectedStyle == 0) // fixed
        {
            ...
            $('#premiumUserRowInfoControlGroup').hide(animationSpeed);
            $('#playCountVisibleControlGroup').hide(animationSpeed);
        }
        else // customizable
        {
            $('#premiumUserRowInfoControlGroup').show(animationSpeed);
            $('#playCountVisibleControlGroup').show(animationSpeed);            
...
$('#headerColorSelectBox').on('change', function(event) 
{
    UpdatePreview();
});

$('#playCountVisibleControlGroup').on('change', function(event) 
{
    UpdatePreview();
});
